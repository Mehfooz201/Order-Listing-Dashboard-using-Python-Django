    ...
    def thumbnail(self, object):
        try:
            ...
            if (str(object.image.url).split('.')[-1]=="bmp" or
                ...
                pdf_icon = os.path.join(settings.STATIC_URL,"amruloapp/assets/images/pdf-file.png")
                stl_icon = os.path.join(settings.STATIC_URL,"amruloapp/assets/images/stl-file.png")
                dcm_icon = os.path.join(settings.STATIC_URL,"amruloapp/assets/images/dcm-file.png")
                html_icon = os.path.join(settings.STATIC_URL,"amruloapp/assets/images/html-file.png")
