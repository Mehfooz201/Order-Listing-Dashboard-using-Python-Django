(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('Dentcham:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('Dentcham:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
    }
  }, 1000)
  ...
  $container.append(
    '<h5>Customize Dentcham</h5><hr class="mb-2"/>'
  )
