...
function STLViewer(elem, model) {
    ...
    var camera = new THREE.PerspectiveCamera(80, elem.clientWidth / elem.clientHeight, 1, 1000);
    ...
    scene.add(new THREE.HemisphereLight(0xf5151f, 0x010120, 1));
    scene.add(new THREE.HemisphereLight(0x05151f, 0x010120, 1.5));
